...
export class TimelineComponent extends BaseDirective implements OnInit, AfterViewInit {
	...
	public nodeSpawner = new Subject<{ $event: any; actor: Partial<ActorEntity>; block: BlockComponent }>();
	...
	public shift($event: any): void {
		...
		if ($event.type === 'panstart' && this.scrollRef) {
	...
	public spawnNode($event: any, actor: Partial<ActorEntity>, block: BlockComponent): void {
