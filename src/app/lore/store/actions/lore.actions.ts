...
export const loadLoresSuccess = createAction(`[Lore] Load Success`, (payload: Payload<Array<Lore>>): Payload<Array<Lore>> => (payload));
...
export const changeCurrentLore = createAction(`[Lore] Change Current`, (payload: Payload<any> = { payload: {} }) => ({
	payload
}));
