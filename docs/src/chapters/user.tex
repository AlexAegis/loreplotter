...
\begin{itemize}
	\item Bal oldalt a szereplőtár\cref{section:ui-actor-tool} amibel készíteni és válogatni tudunk a szereplőink között.
	\item Alul az idővonal\cref{section:ui-timeline} látható ahol az éppen megtekintett időpontot tudjuk megtekintni/változtatni. Az események idejét szerkeszteni.
\end{itemize}
