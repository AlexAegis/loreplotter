...
\begin{figure}[h!]
	\centering
	\includegraphics{create-project-button}
	\caption{
...
Új projekt létrehozásakor a projekt készítő dialógust kapjuk melyen lehetőséget kapunk a projektünknek nevet adni és a világbeállításokat megadni, mint a bolygó neve és mérete ami alatt a bolygó sugarát értjük kilóméterben megadva.
